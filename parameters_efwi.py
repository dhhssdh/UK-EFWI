...
import os 
from ultils.train_efwi import train_deepwave
...
vp_save_path = './reconstruction/efwi_good_init/fre_loss_6_and_noise5/vp/'
vs_save_path = './reconstruction/efwi_good_init/fre_loss_6_and_noise5/vs/'
rho_save_path = './reconstruction/efwi_good_init/fre_loss_6_and_noise5/rho/'
...
## log_data_path
main_path = './log_data/efwi_good_init/fre_loss_6_and_noise5_tikh/'
...
vp_nn_save_path = './reconstruction/nn_efwi/fre_loss_6_and_noise5/vp/'
vs_nn_save_path = './reconstruction/nn_efwi/fre_loss_6_and_noise5/vs/'
rho_nn_save_path = './reconstruction/nn_efwi/fre_loss_6_and_noise5/rho/'

if not os.path.exists(vp_nn_save_path):
    os.makedirs(vp_nn_save_path)
if not os.path.exists(vs_nn_save_path):
    os.makedirs(vs_nn_save_path)
if not os.path.exists(rho_nn_save_path):
    os.makedirs(rho_nn_save_path)
    
## log_data_path
main_path_nn = './log_data/nn_efwi/fre_loss_6_and_noise5_tikh/'
if not os.path.exists(main_path_nn):
    os.makedirs(main_path_nn)